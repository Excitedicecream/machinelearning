...
with st.expander('2D Data Visualisation'):
    ...
    x_axis = st.selectbox('Select X-axis', options=numeric_columns, index=0, key='x_axis_2d')
    y_axis = st.selectbox('Select Y-axis', options=numeric_columns, index=1, key='y_axis_2d')
